...
# Add current directory to path for deployment
PROJECT_ROOT = Path(__file__).parent
sys.path.insert(0, str(PROJECT_ROOT))

import orb_vessel
import resolution_engine
import ui_overlay.floating_window

# Get the instances
ORB_VESSEL = orb_vessel.ORB_VESSEL
ResolutionEngine = resolution_engine.ResolutionEngine
FLOATING_UI = ui_overlay.floating_window.FLOATING_UI
